...
- [WslShortcut](//github.com/HanabishiRecca/WslShortcut) - Run WSL commands directly in Windows. Also allows to use WSL `git`/`node`/etc. in **Visual Studio Code** or another software. Combines functionality of utilites like [`wslgit`](//github.com/andy-5/wslgit), [`wslnode`](//github.com/int128/wslexec), [`wslexec`](//github.com/snooopcatt/wslnodejs) etc. with simpler usage. ![github project][githublogo]
